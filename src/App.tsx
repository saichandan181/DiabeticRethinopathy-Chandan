  ...
  const exportToPDF = async (result: AnalysisResult) => {
    try {
      ...
      const canvas = await html2canvas(element, {
        ...
        onclone: (clonedDoc) => {
          // Ensure text is sharp in the PDF
      ...
      // Add a white background for better contrast
      ...
      // Save with a formatted date in the filename
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 transition-colors duration-300">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <header className="text-center mb-16">
          <div className="inline-flex items-center justify-center p-3 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full mb-6 shadow-lg transform hover:scale-110 transition-transform duration-300">
            <Microscope className="h-8 w-8 text-white" />
          </div>
          <h1 className="text-5xl font-bold mb-6 bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent animate-gradient">
            Diabetic Retinopathy Detection
          </h1>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Upload a retinal image for instant AI-powered analysis of diabetic retinopathy severity.
            Our advanced system provides accurate classification and detailed insights.
          </p>
        </header>
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          <div className="space-y-8">
            ...
            >
              ...
              <Upload className="mx-auto h-16 w-16 text-blue-400 animate-bounce" />
          ...
          <div className="relative">
            {showHistory ? (
              <div className="bg-gray-800 rounded-2xl shadow-xl p-8 animate-slideIn">
              ...
              <div id="analysis-result" className="bg-gray-800 rounded-2xl shadow-xl p-8 relative overflow-hidden animate-fadeIn">
                ...
                {loading && (
                  <div className="flex flex-col items-center justify-center py-12 animate-pulse">
                    ...
                    <p className="text-lg text-gray-300">Analyzing your retinal image...</p>
                    <p className="text-sm text-gray-500 mt-2">This may take a few moments</p>
                  </div>
                )}

                {error && (
                  <div className="flex items-start gap-3 text-red-400 bg-red-900/20 p-6 rounded-xl animate-shake">
                ...
                {prediction && (
                  <div className="space-y-8 animate-slideUp">
                    <div className="bg-gradient-to-br from-blue-900/20 to-purple-900/20 p-6 rounded-xl transform hover:scale-[1.02] transition-transform duration-300">
                      <h3 className="text-lg font-medium text-gray-200 mb-3">Severity Level</h3>
                    ...
                    <div className="transform hover:scale-[1.01] transition-transform duration-300">
                      <h3 className="text-lg font-medium text-gray-200 mb-3">Detailed Analysis</h3>
                      <p className="text-gray-300 leading-relaxed">{prediction.description}</p>
                    </div>

                    <div className="border-t border-gray-700 pt-6">
                      <h3 className="text-lg font-medium text-gray-200 mb-4">Severity Scale</h3>
                    ...
                    <div className="bg-gray-700/50 p-6 rounded-xl transform hover:scale-[1.01] transition-transform duration-300">
                      <p className="font-medium text-gray-200 mb-2">Important Disclaimer:</p>
                      <p className="text-gray-300 text-sm leading-relaxed">
                        This AI-powered screening tool is designed to assist in the detection of diabetic retinopathy but should not be used as a replacement for professional medical diagnosis. Always consult with your healthcare provider for proper medical advice and treatment decisions.
                      </p>
                    </div>
                  </div>
                )}
            ...
            <div className="p-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-white">What is Diabetic Retinopathy?</h3>
                ...
                <div className="space-y-4">
                  <h3 className="text-xl font-semibold text-white">Stages and Symptoms</h3>
                  <div className="space-y-3">
                    {Object.entries(DR_LEVELS).map(([level, stage]) => (
                      <div key={level} className="p-3 bg-gray-700/50 rounded-lg">
              ...
              <div className="mt-8 p-4 bg-purple-900/20 rounded-lg">
                <h3 className="text-xl font-semibold text-purple-300 mb-3">Prevention Tips</h3>
      ...
      <footer className="bg-gray-800/80 backdrop-blur-lg border-t border-gray-700 py-12 mt-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="text-center transform hover:scale-105 transition-transform duration-300">
              <h3 className="font-semibold text-white mb-1">S. Reddy Sai Chandan</h3>
            ...
            <div className="text-center transform hover:scale-105 transition-transform duration-300">
              <h3 className="font-semibold text-white mb-1">O Sowmyanath</h3>
              <p className="text-blue-400 text-sm mb-2">ML Engineer</p>
              <div className="flex justify-center space-x-2">
                <button className="p-2 text-gray-400 hover:text-blue-400 transition-colors">
                  <Github className="h-5 w-5" />
                </button>
            ...
            <div className="text-center transform hover:scale-105 transition-transform duration-300">
              <h3 className="font-semibold text-white mb-1">Sri Keerthi</h3>
              <p className="text-blue-400 text-sm mb-2">Lead</p>
              <div className="flex justify-center space-x-2">
                <button className="p-2 text-gray-400 hover:text-blue-400 transition-colors">
                  <Github className="h-5 w-5" />
                </button>
            ...
            <div className="text-center transform hover:scale-105 transition-transform duration-300">
              <h3 className="font-semibold text-white mb-1">Srindhi</h3>
              <p className="text-blue-400 text-sm mb-2">Data Scientist</p>
              <div className="flex justify-center space-x-2">
                <button className="p-2 text-gray-400 hover:text-blue-400 transition-colors">
                  <Github className="h-5 w-5" />
                </button>
          ...
          <div className="text-center mt-12 text-sm text-gray-400">
            <p>© 2024 Diabetic Retinopathy Detection. All rights reserved.</p>
          </div>
        </div>
      </footer>
      ...
      {showFullImage && image && (
        <div 
          className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-8 animate-fadeIn"
